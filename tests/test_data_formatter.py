...
class TestUsersDataFormatter(unittest.TestCase):
    ...
    def test_format_telephone_number(self):
        ...
        self.assertEqual("847940862", UsersDataFormatter.format_telephone_number(phone_zeros))

        # Test case: phone with plus and area code
        phone_plus_area_code = "+48844840862"
        self.assertEqual("844840862", UsersDataFormatter.format_telephone_number(phone_plus_area_code))

        # Test case: phone with area code in parentheses
        phone_area_code_in_parentheses = "(48)123123123"
        self.assertEqual("123123123", UsersDataFormatter.format_telephone_number(phone_area_code_in_parentheses))

        # Test case: phone with space
        phone_with_spaces = "123 123 123"
        self.assertEqual("123123123", UsersDataFormatter.format_telephone_number(phone_with_spaces))

        # Test case: phone with leading zeros and spaces
        phone_zeros_spaces = "00 123 123 123"
        self.assertEqual("123123123", UsersDataFormatter.format_telephone_number(phone_zeros_spaces))

        # Test case: phone correct format, nothing to change
        phone_correct = "123123123"
        self.assertEqual("123123123", UsersDataFormatter.format_telephone_number(phone_correct))

    def test_filter_valid_data(self):
        # Test case: valid test data as list of dict
        test_data = [{"name": "user1"}, None, {"name": "user2"}, None]
        self.assertEqual(2, len(UsersDataFormatter.filter_valid_data(test_data)))
        ...
        self.assertEqual(0, len(UsersDataFormatter.filter_valid_data(test_data1)))
